...
```
<!--more-->
<center>![avatar](https://gitee.com/zhoulee/blog-images/raw/master/compile_process.jpg)</center>
...
可重定位目标文件格式如下：
<center>![avatar](https://gitee.com/zhoulee/blog-images/raw/master/elf_format.jpg)</center>
...
<center>![avatar](https://gitee.com/zhoulee/blog-images/raw/master/link_error.jpg)</center>
...
<center>![动态共享库链接过程](https://gitee.com/zhoulee/blog-images/raw/master/dynamic_library_load.jpg)</center>
...
<center>![模块内函数调用示例](https://gitee.com/zhoulee/blog-images/raw/master/moudle_inner_function.jpg)</center>
<center>![模块内数据引用示例](https://gitee.com/zhoulee/blog-images/raw/master/module_inner_call.jpg)</center>
...
<center>![模块外部数据GOT引用示例](https://gitee.com/zhoulee/blog-images/raw/master/extern_data_reference.jpg)</center>

PIC函数调用通过GOT和PLT(Procedure Linkage Table,过程链接表)实现。
<center>![模块间函数调用](https://gitee.com/zhoulee/blog-images/raw/master/moudle_call.jpg)</center>
<center>![模块间函数调用](https://gitee.com/zhoulee/blog-images/raw/master/function_calling.jpg)</center>
